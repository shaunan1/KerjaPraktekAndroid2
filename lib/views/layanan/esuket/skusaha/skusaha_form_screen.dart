...
const String title = 'Surat Keterangan Usaha';
final _formKey = GlobalKey<FormState>();
final dio = Dio();

class EsuketSkusahaFormScreen extends StatefulWidget {
  final int? id;
  const EsuketSkusahaFormScreen({super.key, this.id});

  @override
  State<EsuketSkusahaFormScreen> createState() =>
      _EsuketSkusahaFormScreenState();
}

class _EsuketSkusahaFormScreenState extends State<EsuketSkusahaFormScreen> {
  ...
  TextEditingController namaUsahaCtrl = TextEditingController();
  TextEditingController alamatUsahaCtrl = TextEditingController();
  TextEditingController kategoriCtrl = TextEditingController();
  File? fileUpload;
  bool isLoadingSubmit = false;

  final kategoriItems = [
    MyDropDownItems(text: "Kelurahan", value: "kelurahan"),
    MyDropDownItems(text: "Luar Kelurahan", value: "luar"),
  ];
  ...
  Future handleSubmit() async {
    ...
    try {
      ...
      FormData formData = FormData.fromMap({
        'nik': nikCtrl.text,
        'register_as': kategoriCtrl.text,
        'nama_usaha': namaUsahaCtrl.text,
        'alamat_usaha': alamatUsahaCtrl.text,
      ...
      String url = '${dotenv.env['ESUKET_BASE_URL']}/api/skusaha';
